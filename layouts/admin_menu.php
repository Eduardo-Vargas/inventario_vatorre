<ul>
  ...
  <li>
    ...
    <ul class="nav submenu">
      <li><a href="group.php">Editar Grupos</a> </li>
      <li><a href="users.php">Editar Usuarios</a> </li>
   </ul>
  </li>
  <li>
  ...
  <li>
    ...
    <ul class="nav submenu">
       <li><a href="product.php">Editar Productos</a> </li>
  ...
  <li>
    <a href="#" class="submenu-toggle">
      ...
      <ul class="nav submenu">
         <li><a href="sales.php">Editar Ventas</a> </li>
         <li><a href="add_sale.php">Agregar Ventas</a> </li>
     </ul>
  </li>
  <li>
    <a href="#" class="submenu-toggle">
