              ...
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-btn">
                    <input type="file" name="file_upload" multiple class="btn btn-primary btn-file"/>
                 </span>

                 <button type="submit" name="submit" class="btn btn-default">Agregar</button>
               </div>
              </div>
             </form>
            </div>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Nombre de Foto</th>
